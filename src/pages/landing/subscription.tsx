    ...
    <Layout>
      <section className="relative bg-[#FAFAFA] pt-28 pb-8 lg:pt-32 lg:pb-8 border-b border-line-100 overflow-hidden">
        ...
        <div className="mx-auto w-full max-w-4xl px-6 relative z-10 text-center">
          <div className="w-12 h-12 bg-purple-50 text-purple-500 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-sm">
            <FileText size={24} />
          </div>
          <h1 className="text-2xl font-extrabold text-smoke-900 tracking-tight md:text-3xl lg:text-4xl mb-3">Subscription Agreement</h1>
          <p className="text-sm md:text-base text-smoke-600 font-light">Please carefully read this agreement before using Razzia Merchant Services.</p>
        </div>
      </section>
